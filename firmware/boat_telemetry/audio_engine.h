...
#define GAIN_MIN                0.7f    // Minimum gain (volume at idle) - louder for outdoor use
#define GAIN_MAX                1.3f    // Maximum gain (volume at full throttle) - louder without harsh clipping
